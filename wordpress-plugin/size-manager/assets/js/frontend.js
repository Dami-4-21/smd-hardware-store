/**
 * Size Manager - Frontend JavaScript
...
(function($) {
    ...
    function initSizeSelector() {
        ...
        function formatPrice(price) {
            const symbol = sizeManagerFrontend.currencySymbol;
        ...
        function getUnitLabel() {
            const unitType = sizeManagerFrontend.unitType;
            const strings = sizeManagerFrontend.strings;
            
            const labels = {
                'piece': strings.perPiece,
                'kg': strings.perKg,
                'meter': strings.perMeter,
                'liter': strings.perLiter
            };
            
            return labels[unitType] || strings.perPiece;
        }
