        ...
        <div className="px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-semibold text-gray-900">My Quotations</h1>
      ...
      <div className="px-4 py-6">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              <h3 className="font-medium text-red-900">Error Loading Quotations</h3>
        ...
        {!loading && !error && quotations.length === 0 && (
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              You haven't submitted any quotations. Start shopping to create your first quotation!
            </p>
            <button
              onClick={onBack}
